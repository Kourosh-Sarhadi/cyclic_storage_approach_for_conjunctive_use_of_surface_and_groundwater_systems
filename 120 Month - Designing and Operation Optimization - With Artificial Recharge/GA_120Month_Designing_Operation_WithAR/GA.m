...
lb=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B5:AAX5');  % Lower Bound of Variables
ub=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B6:AAX6'); % Upper Bound of Variables
...
%% results
writematrix(gpop.par,'Results_GA_120Month_Designing_and_Operation_WithAR.xlsx','Sheet',1,'Range','B4:AAX4');
%writematrix(best,'Best_GA_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','K2:K4001');
disp(' ')
