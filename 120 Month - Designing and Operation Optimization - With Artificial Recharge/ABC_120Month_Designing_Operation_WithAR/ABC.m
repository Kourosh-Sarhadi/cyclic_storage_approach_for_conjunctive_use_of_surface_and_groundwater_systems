...
lb=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B10:AAX10');  % Lower Bound of Variables
ub=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B11:AAX11'); % Upper Bound of Variables
...
%% results
writematrix(gfood.x,'Results_ABC_120Month_Designing_and_Operation_WithAR.xlsx','Sheet',1,'Range','B4:AAX4');
