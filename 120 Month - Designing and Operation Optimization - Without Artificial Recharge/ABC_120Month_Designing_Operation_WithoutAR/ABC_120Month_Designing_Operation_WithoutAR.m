...
t=1:1:120;
%---------------------------------------------------------%
Rsd=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','B4:DQ4');
DivD=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','DR4:IG4');
Rsriv=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','IH4:MW4');
Rgd=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','MX4:RM4');
CapD=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','RN4:RN4');
CapCD=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','RO4:RO4');
CapDivD=readmatrix('Results_ABC_120Month_Designing_Operation_WithoutAR.xlsx','Sheet',1,'Range','RP4:RP4');
%---------------------------------------------------------%
CD=1.5*CapD;
CCD=0.5*CapCD;
CDivD=0.5*CapDivD;
...
writematrix(CapD,'ABC_Simulation.xlsx','Sheet',1,'Range','B25:B25');
writematrix(CapCD,'ABC_Simulation.xlsx','Sheet',1,'Range','B26:B26');
writematrix(CapDivD,'ABC_Simulation.xlsx','Sheet',1,'Range','B27:B27');
