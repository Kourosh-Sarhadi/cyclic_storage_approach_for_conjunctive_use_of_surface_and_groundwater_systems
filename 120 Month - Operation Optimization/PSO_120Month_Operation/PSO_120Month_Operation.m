...
t=1:1:120;
%---------------------------------------------------------%
Rsd=readmatrix('Results_PSO_120Month_Operation.xlsx','Sheet',1,'Range','B4:DQ4');
DivD=readmatrix('Results_PSO_120Month_Operation.xlsx','Sheet',1,'Range','DR4:IG4');
Rsriv=readmatrix('Results_PSO_120Month_Operation.xlsx','Sheet',1,'Range','IH4:MW4');
Rgd=readmatrix('Results_PSO_120Month_Operation.xlsx','Sheet',1,'Range','MX4:RM4');
%---------------------------------------------------------%
CD=1.5*CapD;
CCD=0.5*CapCD;
CDivD=0.5*CapDivD;
...
writematrix(Rsd,'PSO_Simulation.xlsx','Sheet',1,'Range','B2:DR2');
writematrix(DivD,'PSO_Simulation.xlsx','Sheet',1,'Range','B3:DR3');
writematrix(Rsriv,'PSO_Simulation.xlsx','Sheet',1,'Range','B4:DR4');
writematrix(Rgd,'PSO_Simulation.xlsx','Sheet',1,'Range','B5:DR5');
writematrix(fy,'PSO_Simulation.xlsx','Sheet',1,'Range','B6:DR6');
writematrix(def,'PSO_Simulation.xlsx','Sheet',1,'Range','B7:DR7');
writematrix(Ss,'PSO_Simulation.xlsx','Sheet',1,'Range','B8:DR8');
writematrix(As,'PSO_Simulation.xlsx','Sheet',1,'Range','B9:DR9');
writematrix(Es,'PSO_Simulation.xlsx','Sheet',1,'Range','B10:DR10');
writematrix(Sg,'PSO_Simulation.xlsx','Sheet',1,'Range','B11:DR11');
writematrix(DeltaSg,'PSO_Simulation.xlsx','Sheet',1,'Range','B12:DR12');
writematrix(dhg,'PSO_Simulation.xlsx','Sheet',1,'Range','B13:DR13');
writematrix(hg,'PSO_Simulation.xlsx','Sheet',1,'Range','B14:DR14');
writematrix(hriv,'PSO_Simulation.xlsx','Sheet',1,'Range','B15:DR15');
writematrix(qinriv1,'PSO_Simulation.xlsx','Sheet',1,'Range','B16:DR16');
writematrix(qlriv1,'PSO_Simulation.xlsx','Sheet',1,'Range','B17:DR17');
writematrix(qoutriv1,'PSO_Simulation.xlsx','Sheet',1,'Range','B18:DR18');
writematrix(qinriv2,'PSO_Simulation.xlsx','Sheet',1,'Range','B19:DR19');
writematrix(qlriv2,'PSO_Simulation.xlsx','Sheet',1,'Range','B20:DR20');
writematrix(qoutriv2,'PSO_Simulation.xlsx','Sheet',1,'Range','B21:DR21');
writematrix(qraq,'PSO_Simulation.xlsx','Sheet',1,'Range','B22:DR22');
writematrix(qraqv,'PSO_Simulation.xlsx','Sheet',1,'Range','B23:DR23');
