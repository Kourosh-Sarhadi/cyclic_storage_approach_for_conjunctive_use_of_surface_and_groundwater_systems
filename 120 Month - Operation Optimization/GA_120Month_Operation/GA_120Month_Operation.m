...
t=1:1:120;
%---------------------------------------------------------%
Rsd=readmatrix('Results_GA_120Month_Operation.xlsx','Sheet',1,'Range','B4:DQ4');
DivD=readmatrix('Results_GA_120Month_Operation.xlsx','Sheet',1,'Range','DR4:IG4');
Rsriv=readmatrix('Results_GA_120Month_Operation.xlsx','Sheet',1,'Range','IH4:MW4');
Rgd=readmatrix('Results_GA_120Month_Operation.xlsx','Sheet',1,'Range','MX4:RM4');
%---------------------------------------------------------%
CD=1.5*CapD;
CCD=0.5*CapCD;
CDivD=0.5*CapDivD;
...
writematrix(Rsd,'GA_Simulation.xlsx','Sheet',1,'Range','B2:DR2');
writematrix(DivD,'GA_Simulation.xlsx','Sheet',1,'Range','B3:DR3');
writematrix(Rsriv,'GA_Simulation.xlsx','Sheet',1,'Range','B4:DR4');
writematrix(Rgd,'GA_Simulation.xlsx','Sheet',1,'Range','B5:DR5');
writematrix(fy,'GA_Simulation.xlsx','Sheet',1,'Range','B6:DR6');
writematrix(def,'GA_Simulation.xlsx','Sheet',1,'Range','B7:DR7');
writematrix(Ss,'GA_Simulation.xlsx','Sheet',1,'Range','B8:DR8');
writematrix(As,'GA_Simulation.xlsx','Sheet',1,'Range','B9:DR9');
writematrix(Es,'GA_Simulation.xlsx','Sheet',1,'Range','B10:DR10');
writematrix(Sg,'GA_Simulation.xlsx','Sheet',1,'Range','B11:DR11');
writematrix(DeltaSg,'GA_Simulation.xlsx','Sheet',1,'Range','B12:DR12');
writematrix(dhg,'GA_Simulation.xlsx','Sheet',1,'Range','B13:DR13');
writematrix(hg,'GA_Simulation.xlsx','Sheet',1,'Range','B14:DR14');
writematrix(hriv,'GA_Simulation.xlsx','Sheet',1,'Range','B15:DR15');
writematrix(qinriv1,'GA_Simulation.xlsx','Sheet',1,'Range','B16:DR16');
writematrix(qlriv1,'GA_Simulation.xlsx','Sheet',1,'Range','B17:DR17');
writematrix(qoutriv1,'GA_Simulation.xlsx','Sheet',1,'Range','B18:DR18');
writematrix(qinriv2,'GA_Simulation.xlsx','Sheet',1,'Range','B19:DR19');
writematrix(qlriv2,'GA_Simulation.xlsx','Sheet',1,'Range','B20:DR20');
writematrix(qoutriv2,'GA_Simulation.xlsx','Sheet',1,'Range','B21:DR21');
writematrix(qraq,'GA_Simulation.xlsx','Sheet',1,'Range','B22:DR22');
writematrix(qraqv,'GA_Simulation.xlsx','Sheet',1,'Range','B23:DR23');
