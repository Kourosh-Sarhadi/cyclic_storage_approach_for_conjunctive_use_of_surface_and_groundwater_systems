...
maxiter=2000;      % max of iteration

pc=0.12;                  % percent of crossover
...
lb=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B14:RM14');  % Lower Bound of Variables
ub=readmatrix('LB & UB 120 Month.xlsx','Sheet',1,'Range','B15:RM15'); % Upper Bound of Variables
...
%% results
writematrix(gpop.par,'Results_GA_120Month_Operation.xlsx','Sheet',1,'Range','B4:RM4');
disp(' ')
