...
t=1:1:120;
%---------------------------------------------------------%
Rsd=readmatrix('Results_ABC_120Month_Operation.xlsx','Sheet',1,'Range','B4:DQ4');
DivD=readmatrix('Results_ABC_120Month_Operation.xlsx','Sheet',1,'Range','DR4:IG4');
Rsriv=readmatrix('Results_ABC_120Month_Operation.xlsx','Sheet',1,'Range','IH4:MW4');
Rgd=readmatrix('Results_ABC_120Month_Operation.xlsx','Sheet',1,'Range','MX4:RM4');
%---------------------------------------------------------%
CD=1.5*CapD;
CCD=0.5*CapCD;
CDivD=0.5*CapDivD;
...
writematrix(Rsd,'ABC_Simulation.xlsx','Sheet',1,'Range','B2:DR2');
writematrix(DivD,'ABC_Simulation.xlsx','Sheet',1,'Range','B3:DR3');
writematrix(Rsriv,'ABC_Simulation.xlsx','Sheet',1,'Range','B4:DR4');
writematrix(Rgd,'ABC_Simulation.xlsx','Sheet',1,'Range','B5:DR5');
writematrix(fy,'ABC_Simulation.xlsx','Sheet',1,'Range','B6:DR6');
writematrix(def,'ABC_Simulation.xlsx','Sheet',1,'Range','B7:DR7');
writematrix(Ss,'ABC_Simulation.xlsx','Sheet',1,'Range','B8:DR8');
writematrix(As,'ABC_Simulation.xlsx','Sheet',1,'Range','B9:DR9');
writematrix(Es,'ABC_Simulation.xlsx','Sheet',1,'Range','B10:DR10');
writematrix(Sg,'ABC_Simulation.xlsx','Sheet',1,'Range','B11:DR11');
writematrix(DeltaSg,'ABC_Simulation.xlsx','Sheet',1,'Range','B12:DR12');
writematrix(dhg,'ABC_Simulation.xlsx','Sheet',1,'Range','B13:DR13');
writematrix(hg,'ABC_Simulation.xlsx','Sheet',1,'Range','B14:DR14');
writematrix(hriv,'ABC_Simulation.xlsx','Sheet',1,'Range','B15:DR15');
writematrix(qinriv1,'ABC_Simulation.xlsx','Sheet',1,'Range','B16:DR16');
writematrix(qlriv1,'ABC_Simulation.xlsx','Sheet',1,'Range','B17:DR17');
writematrix(qoutriv1,'ABC_Simulation.xlsx','Sheet',1,'Range','B18:DR18');
writematrix(qinriv2,'ABC_Simulation.xlsx','Sheet',1,'Range','B19:DR19');
writematrix(qlriv2,'ABC_Simulation.xlsx','Sheet',1,'Range','B20:DR20');
writematrix(qoutriv2,'ABC_Simulation.xlsx','Sheet',1,'Range','B21:DR21');
writematrix(qraq,'ABC_Simulation.xlsx','Sheet',1,'Range','B22:DR22');
writematrix(qraqv,'ABC_Simulation.xlsx','Sheet',1,'Range','B23:DR23');
